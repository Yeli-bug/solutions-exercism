...
export function remainingMinutesInOven(actualMinutesInOven) {
  var rema = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
  console.log("cuanto tiempo le falta",rema);
  return rema;
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  var prepa = PREPARATION_MINUTES_PER_LAYER * numberOfLayers;
  console.log("tiempo de preparacion de una capa",prepa);
    return prepa;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  var totalMinutes = actualMinutesInOven + preparationTimeInMinutes(numberOfLayers);
